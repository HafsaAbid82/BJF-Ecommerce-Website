...
const Location = () => {
  return(
    <Box sx={{ position: 'relative', width: '100vw',  px: { xs: 2, md: 0 } }}>
      <Box sx={{ 
        display: 'flex', 
        backgroundImage: 'linear-gradient(135deg, #000000 30%, #88BDA8 60%, #000000)',
    ...
    '@keyframes gradientShift': {
      ...
      '100%': { backgroundPosition: '0% 50%' }
        ...
        <Box sx={{ 
          ...
          >
            Big Jerry's Fencing companies are located in 21 cities in nine different states serving Atlanta, Charlotte, Clayton, Creedmoor, Durham, 
