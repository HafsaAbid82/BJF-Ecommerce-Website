...
const Video = () => {
  ...
  const preparationSteps = [
    {
      videoUrl: "https://youtu.be/maCS0DCH-o0",
      thumbnail: Vs
    },
    {
      videoUrl: "https://youtu.be/rmjEgK19MDk",
      thumbnail: MPP
    },
    {
      videoUrl: "https://youtu.be/lcsf3L-462c",
      thumbnail: HOA
    },
    {
      videoUrl: "https://youtu.be/jkldxKgU2S0",
      thumbnail: Cap
    }
  ];
      ...
      <Container maxWidth="lg">
        <Fade in={inView} timeout={1000}>
          <Box sx={{ position: 'relative', zIndex: 1 }}>
            ...
            >
              Preparing for your fence with Big Jerry's Fencing
            </Typography>
