      ...
      <Fade in={inView} timeout={1000}>
        <Container maxWidth="lg">
          ...
          <Box sx={{
            ...
            >
              Need financing? Bad credit? No problem.
          ...
          >
            ...
            >
              ...
              {/* Amount Input */}
              <Box sx={{ mb: 3 }}>
                <Typography variant="body1" sx={{ mb: 1, color: '#F5F5F5!important', textAlign: 'left' }}>
                ...
                />
                <Typography variant="body2" sx={{ color: '#F5F5F5', opacity: 0.8, textAlign: 'left' }}>
                  Min: $0 - Max: $50,000
                </Typography>
              </Box>
            ...
            >
              ...
              >
                <Typography
                  variant="h6"
                  sx={{ mb: 1, color: '#F5F5F5', fontWeight: 600, fontSize: 22, textAlign: 'left', ml: -2 }}
                >
                  Monthly Payment
                </Typography>
                <Typography
                  variant="h3"
                  sx={{ color: '#789f80ff', fontWeight: 600, fontSize: 20, textAlign: 'right' }}
                >
                  ${monthlyPayment}
                </Typography>
              </Box>
